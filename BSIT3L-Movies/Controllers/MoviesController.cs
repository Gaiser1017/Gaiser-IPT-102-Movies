    ...
    public class MoviesController : Controller
    {
        ...
        public MoviesController()
        {
            ...
            _movies = new List<MovieViewModel>
            {
                ...
                new MovieViewModel { Id = 11, Name = "Iron Man", Rating = "1", Image = "css/picture/Pic1.jpg", Details = "https://www.youtube.com/watch?v=ZlNFpri-Y40", Description = "Scott Lang and Hope Van Dyne are dragged into the Quantum Realm, along with Hope's parents and Scott's daughter Cassie. Together they must find a way to escape, but what secrets is Hope's mother hiding? And who is the mysterious Kang?\\r\n" },
                new MovieViewModel { Id = 12, Name = "Iron Man", Rating = "1", Image = "css/picture/Pic1.jpg", Details = "https://www.youtube.com/watch?v=wS_qbDztgVY", Description = "Carol Danvers becomes one of the universe's most powerful heroes when Earth is caught in the middle of a galactic war between two alien races.\r\n" },
                new MovieViewModel { Id = 13, Name = "Iron Man", Rating = "1", Image = "css/picture/Pic1.jpg", Details = "https://www.youtube.com/watch?v=hA6hldpSTF8", Description = "After the devastating events of Avengers: Infinity War (2018), the universe is in ruins. With the help of remaining allies, the Avengers assemble once more in order to reverse Thanos' actions and restore balance to the universe.\r\n" },
                new MovieViewModel { Id = 14, Name = "Iron Man", Rating = "1", Image = "css/picture/Pic1.jpg", Details = "https://www.youtube.com/watch?v=8YjFbMbfXaQ", Description = "Shang-Chi, the master of weaponry-based Kung Fu, is forced to confront his past after being drawn into the Ten Rings organization.\r\n" },
                new MovieViewModel { Id = 15, Name = "Iron Man", Rating = "1", Image = "css/picture/Pic1.jpg", Details = "https://www.youtube.com/watch?v=smfEF8xeBu4", Description = "Thor enlists the help of Valkyrie, Korg and ex-girlfriend Jane Foster to fight Gorr the God Butcher, who intends to make the gods extinct.\r\n" },
            };
        }
